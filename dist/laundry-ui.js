...
function guidance(o){
 ...
 if(o.status==='RETURN REQUESTED')return {title:'Kembalikan barang pelanggan',text:'Catat penerima dan bukti pengembalian. Periksa refund bila sudah ada pembayaran.',tone:'warning',primary:'return'};
 ...
 if(['CANCELLED','VOIDED','LINKED'].includes(o.status))return {title:root.THLaundryLabel(o.status),text:'Riwayat order tetap tersimpan. Periksa refund atau setoran bila masih terbuka.',tone:'warning'};
