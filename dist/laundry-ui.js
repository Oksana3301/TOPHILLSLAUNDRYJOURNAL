...
function alert(text){return `<div class="alert danger">${icon('danger')}<span>${E(root.THCopy?root.THCopy.wording(alertNames[text]||text):alertNames[text]||text)}</span></div>`;}
